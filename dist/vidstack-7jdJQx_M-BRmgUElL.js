...
import { m as St, o as L, R as At, A as Z, B as It, D as tt, c as V, l as et, e as Rt, C as bt, L as wt } from "./main-Iwf5eNYg.js";
import { getCastContext as Mt, getCastSession as Dt, getCastSessionMedia as it, hasActiveCastSession as st, listenCastContextEvent as Nt, getCastErrorMessage as Pt } from "./vidstack-BEzgE0Fx-CwWqglwj.js";
var g, _, at;
class _t {
  constructor(t) {
    T(this, _);
...
class xt {
  ...
  setup() {
    ...
    et(e(this, k).audioTracks, "change", t), et(e(this, k).textTracks, "mode-change", t), Rt(r(this, h, nt).bind(this));
  }
  getLocalTextTracks() {
  ...
  syncRemoteTracks(t) {
    ...
    const s = r(this, h, $).call(this), i = this.getLocalTextTracks(), n = r(this, h, A).call(this, chrome.cast.media.TrackType.AUDIO), m = r(this, h, A).call(this, chrome.cast.media.TrackType.TEXT);
    for (const u of n) {
      if (r(this, h, H).call(this, s, u)) continue;
      const w = {
    ...
    for (const u of m) {
      if (r(this, h, H).call(this, i, u)) continue;
      const w = {
        id: u.trackId.toString(),
  ...
  syncRemoteActiveIds(t) {
    if (!e(this, p).isMediaLoaded) return;
    const s = r(this, h, rt).call(this), i = new chrome.cast.media.EditTracksInfoRequest(s);
    r(this, h, ot).call(this, i).catch((n) => {
    });
  }
}
p = new WeakMap(), k = new WeakMap(), M = new WeakMap(), h = new WeakSet(), $ = function() {
  ...
  const t = [], s = r(this, h, $).call(this).find((n) => n.selected), i = this.getLocalTextTracks().filter((n) => n.mode === "showing");
  if (s) {
    const n = r(this, h, A).call(this, chrome.cast.media.TrackType.AUDIO), m = r(this, h, P).call(this, n, s);
    m && t.push(m.trackId);
  }
  if (i != null && i.length) {
    const n = r(this, h, A).call(this, chrome.cast.media.TrackType.TEXT);
    if (n.length)
      for (const m of i) {
        const u = r(this, h, P).call(this, n, m);
        u && t.push(u.trackId);
      }
  }
  return t;
  ...
  if (!e(this, p).isMediaLoaded) return;
  const s = r(this, h, A).call(this, chrome.cast.media.TrackType.TEXT);
  for (const i of t)
    if (!r(this, h, P).call(this, s, i)) {
      bt(() => {
        var m;
  ...
  return t.find((i) => r(this, h, U).call(this, i, s));
}, P = function(t, s) {
  return t.find((i) => r(this, h, U).call(this, s, i));
...
var o, c, C, E, D, I, v, S, R, N, f, b, a, ct, ht, F, dt, q, ut, lt, mt, B, X, Y, K, Tt, ft, gt, j, kt, z, yt, J, y, pt, Ct, Q, Et;
class $t {
  constructor(t, s) {
    T(this, a);
    ...
    T(this, f, null);
    T(this, b, !1);
    l(this, o, t), l(this, c, s), l(this, C, new xt(t, s, r(this, a, Et).bind(this)));
  }
  get type() {
    return "google-cast";
  }
  ...
  setup() {
    r(this, a, ct).call(this), r(this, a, ht).call(this), e(this, C).setup(), e(this, c).notify("provider-setup", this);
  }
  async play() {
    var t;
  ...
  setCurrentTime(t) {
    var s;
    e(this, o).currentTime = t, e(this, c).notify("seeking", t), (s = e(this, o).controller) == null || s.seek();
  }
  setVolume(t) {
    var s;
  ...
  async loadSource(t) {
    ...
    e(this, c).notify("load-start");
    const s = r(this, a, Ct).call(this, t), i = await this.session.loadMedia(s);
    if (i) {
      l(this, E, null), e(this, c).notify("error", Error(Pt(i)));
      return;
    }
    l(this, E, t);
  }
...
o = new WeakMap(), c = new WeakMap(), C = new WeakMap(), E = new WeakMap(), D = new WeakMap(), I = new WeakMap(), v = new WeakMap(), S = new WeakMap(), R = new WeakMap(), N = new WeakMap(), f = new WeakMap(), b = new WeakMap(), a = new WeakSet(), ct = function() {
  Nt(
  ...
  const { muted: s, volume: i, savedState: n } = e(this, c).$state, m = n();
  ...
  const { remotePlaybackLoader: t } = e(this, c).$state;
  t.set(null);
}, ut = function() {
  const { savedState: t } = e(this, c).$state;
  t.set({
  ...
  l(this, D, i), e(this, c).notify("remote-playback-change", n, m), i === "disconnected" && r(this, a, ut).call(this);
}, X = function(t) {
  if (!!!e(this, o).isMediaLoaded) return;
  const i = V(e(this, c).$state.source);
  Promise.resolve().then(() => {
    if (i !== V(e(this, c).$state.source) || !e(this, o).isMediaLoaded) return;
    ...
    e(this, c).notify("loaded-metadata", void 0, u), e(this, c).notify("loaded-data", void 0, u), e(this, c).notify("can-play", m, u), r(this, a, Y).call(this), r(this, a, K).call(this, t);
    const { volume: x, muted: w } = e(this, c).$state;
    this.setVolume(x()), this.setMuted(w()), e(this, R).start(), e(this, C).syncRemoteTracks(u), e(this, C).syncRemoteActiveIds(u);
  });
}, Y = function() {
  e(this, c).$state.canSetVolume.set(e(this, o).canControlVolume);
}, K = function(t) {
  const s = r(this, a, y).call(this, t);
  e(this, c).notify("stream-type-change", r(this, a, Tt).call(this), s);
}, Tt = function() {
  var s;
  ...
  t !== e(this, I) && (e(this, c).notify("time-change", t), t > e(this, v) && (l(this, v, t), r(this, a, z).call(this)), e(this, c).$state.seeking() && e(this, c).notify("seeked", t), l(this, I, t));
}, gt = function(t) {
  if (!e(this, o).isMediaLoaded || e(this, f)) return;
  const s = e(this, o).duration, i = r(this, a, y).call(this, t);
  l(this, S, new L(0, s)), e(this, c).notify("duration-change", s, i);
}, j = function(t) {
  if (!e(this, o).isMediaLoaded) return;
  const s = {
  ...
  e(this, c).notify("volume-change", s, i);
}, kt = function(t) {
  const s = r(this, a, y).call(this, t);
  e(this, o).isPaused ? e(this, c).notify("pause", void 0, s) : e(this, c).notify("play", void 0, s);
}, z = function(t) {
  const s = {
    seekable: r(this, a, J).call(this),
    buffered: new L(0, e(this, v))
  }, i = t ? r(this, a, y).call(this, t) : void 0;
  e(this, c).notify("progress", s, i);
}, yt = function(t) {
  ...
  switch (s) {
    case i.PLAYING:
      e(this, c).notify("playing", void 0, n);
      break;
    case i.BUFFERING:
      e(this, c).notify("waiting", void 0, n);
      break;
    case i.IDLE:
      e(this, R).stop(), e(this, c).notify("pause"), e(this, c).notify("end");
      break;
  }
}, J = function() {
  ...
  const { streamType: s, title: i, poster: n } = e(this, c).$state;
  return new _t(t).setMetadata(i(), n()).setStreamType(s()).setTracks(e(this, C).getLocalTextTracks()).build();
}, Ct = function(t) {
  var m, u;
  const s = r(this, a, pt).call(this, t), i = new chrome.cast.media.LoadRequest(s), n = e(this, c).$state.savedState();
...
export {
  $t as GoogleCastProvider
};
//# sourceMappingURL=vidstack-7jdJQx_M-BRmgUElL.js.map
