...
import { H as d, s as p, a as u } from "./main-DtExvtVe.js";
class n extends d {
  constructor(t, r) {
    super(t, r);
    s(this, "$$PROVIDER_TYPE", "AUDIO");
    s(this, "airPlay");
    p(() => {
      this.airPlay = new u(this.media, r);
    }, this.scope);
  }
  get type() {
    return "audio";
...
//# sourceMappingURL=vidstack-i8ZXTtoj-BMtItnrH.js.map
