...
import { IS_SERVER, useMediaState, isRemotionSrc, Primitive, useSliderState } from '../chunks/vidstack-C-WrcxmD.js';
export { isRemotionProvider } from '../chunks/vidstack-C-WrcxmD.js';
...
class RemotionProviderLoader {
  ...
  async load(ctx) {
    return new (await import('../chunks/vidstack-Cgi8sOFa.js')).RemotionProvider(this.target, ctx);
  }
}
