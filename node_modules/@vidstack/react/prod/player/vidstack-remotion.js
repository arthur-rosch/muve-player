...
import { IS_SERVER, useMediaState, isRemotionSrc, Primitive, useSliderState } from '../chunks/vidstack-WyKbSRm0.js';
export { isRemotionProvider } from '../chunks/vidstack-WyKbSRm0.js';
...
class RemotionProviderLoader {
  ...
  async load(ctx) {
    return new (await import('../chunks/vidstack-CFWjwplp.js')).RemotionProvider(this.target, ctx);
  }
}
