...
async function parseTextStream(stream, options) {
  ...
  if (typeof type === "string") {
    switch (type) {
      case "srt":
        factory = (await import("./srt-parser-DZRZPQ5J.js")).default;
        break;
      case "ssa":
      case "ass":
        factory = (await import("./ssa-parser-VQT6R6NN.js")).default;
        break;
      default:
...
var VTTParser = class {
  ...
  async init(init) {
    ...
    if (init.strict)
      this._block = 1;
    if (init.errors)
      this._errorBuilder = (await import("./errors-WNLG2E3P.js")).ParseErrorBuilder;
  }
...
//# sourceMappingURL=chunk-JNL4RHA4.js.map
