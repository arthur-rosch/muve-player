...
var AudioProviderLoader = class {
  ...
  async load(ctx) {
    ...
    return new (await import("./vidstack-CvY7pagE-TGBY4JJL.js")).AudioProvider(this.target, ctx);
  }
};
...
var _HLSProviderLoader = class _HLSProviderLoader extends VideoProviderLoader {
  ...
  async load(context) {
    ...
    return new (await import("./vidstack-GNfRj3wa-FFW42XTW.js")).HLSProvider(this.target, context);
  }
};
...
var VimeoProviderLoader = class {
  ...
  async load(ctx) {
    ...
    return new (await import("./vidstack-DF6waG6B-CMGJKTSZ.js")).VimeoProvider(this.target, ctx);
  }
...
var YouTubeProviderLoader = class {
  ...
  async load(ctx) {
    ...
    return new (await import("./vidstack-Breph70c-ROFKLF4U.js")).YouTubeProvider(this.target, ctx);
  }
  async loadPoster(src, ctx, abort) {
  ...
  async requestGoogleCast(trigger) {
    try {
      ...
      if (!__privateGet(this, _googleCastLoader)) {
        const $module = await import("./vidstack-C8ZxSSGF-D277TDQP.js").then(function(n) {
          return n.loader;
        });
...
//# sourceMappingURL=chunk-QJ74WF75.js.map
